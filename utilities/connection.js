...
//return db model in connection object 
let connection = {}

connection.getAdmissionCollection = () => {
    return mongoose.connect(process.env.MONGODB_URI||"mongodb://localhost:27017/AssignmentDemo",{ useNewUrlParser: true }).then((db) => {
